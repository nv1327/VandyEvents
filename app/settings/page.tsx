                        ...
                        <div className="mt-6 grid grid-cols-12 gap-6">
                            ...
                            <div className="col-span-12">
                                <div>
                                    ...
                                    <div className="relative mt-2 rounded-md shadow-sm border border-black pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
